...
@Alias("WithOptionsWithRequiredParamsFromShowInDslGroup")
public class ConnectionWithOptionsWithRequiredParamsFromShowInDslGroup extends AbstractConnectionProvider {
